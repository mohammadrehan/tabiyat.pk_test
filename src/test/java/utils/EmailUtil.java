...
public class EmailUtil {
    ...
    public static void Email(){
        ...
        //  EmailUtil.sendEmail(session, toEmail, "To Programmer", "This message is to imform you that email from your google account was sent successfully using Java mail API");

        for (String object: toEmailList) {
            sendAttachmentEmail(session, object, "Automation Report Summary", "Kindly receive attached run report." +
                    "Don't reply to this email as this is an automated email. For detailed report or any queries contact: yousuf.alvi@codebtech.com");
        }
    ...
    public static void sendAttachmentEmail(Session session, String toEmail, String subject, String body){
        try{
            ...
            String filename= "D:\\projects\\BankSmartApisAutomation\\target\\site\\serenity\\serenity-summary.html";
