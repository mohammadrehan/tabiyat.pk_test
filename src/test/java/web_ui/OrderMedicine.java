...
public class OrderMedicine {
	...
	public static void OrderMedicineProcess() throws InterruptedException {
		...
		Thread.sleep(800);
		WebElement element1 = driver.findElement(By.xpath("//*[@id=\"root\"]/div[1]/div[2]/div/section/div/div/div/div/div[2]/div[5]/div/a/div/img"));
		jse.executeScript("arguments[0].click()", element1);   // click on the popular product's mosphal
		Thread.sleep(800);
		WebElement element2 = driver.findElement(By.xpath("//*[@id=\"5059\"]/span[1]/span"));
