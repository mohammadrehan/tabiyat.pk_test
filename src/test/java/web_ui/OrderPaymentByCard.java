...
//		jse.executeScript("arguments[0].click()", element9);   // click on the Add Address button
		Thread.sleep(1000);
		WebElement element5a = driver.findElement(By.xpath("//*[@id=\"root\"]/div[1]/div[2]/div/section/div[2]/div/div[1]/div/div[1]/div[2]/div[1]/div[3]"));
		...
		element11.sendKeys("This is Automate Order and Payment by CARD ");
		Thread.sleep(1000);
		...
		//Thread.sleep(3000);
		WebElement element14 = driver.findElement(By.xpath("//*[@id=\"CardNumber\"]"));
		element14.sendKeys("5440123456789012");   // Enter the Card number
		Thread.sleep(1000);
		WebElement element15 = driver.findElement(By.xpath("//*[@id=\"CVV\"]"));
		element15.sendKeys("119");    // Enter the cvv number
		Thread.sleep(800);
